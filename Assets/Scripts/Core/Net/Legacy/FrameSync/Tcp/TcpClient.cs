...
// using Net.Protocols.Tcp.Handlers;
// using Net.Protocols.Tcp.Messages.C2S;
// using Net.Protocols.Tcp.Messages.S2C;
// using Net.Sync;
// using Net.SyncModule.Interface;
// using Net.SyncModule.Manager;
// using Net.Tcp.Messages;
// using Net.Tcp.Messages.C2S;
// using Net.Tcp.Messages.S2C;
// using UnityEngine;
// using UnityEngine.Events;
//
// namespace Net.Legacy.FrameSync.Tcp
// {
//     /// <summary>
//     /// TCP�ͻ���
//     /// </summary>
...
//         // ������Ϣ����
//         //private readonly HeartMessage _c2S_HeartMessage = new() { SessionID = NetManager.Instance.ClientID };
//         // ��Ϣ������
...
//         {
//             // Ĭ��
//             _idToHandlerMap.Add(typeof(HeartMessage), new S2C_HeartMessageHandler());
...
//
//             // ͬ�������˳�������Ϣ  TCP�����˳���Ϣ
//             EnqueueMessage(new C2S_QuitRequestMessage() { SessionID = NetManager.Instance.ClientID });
//         }
//
//         /// <summary>
//         /// �ر�����
